...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-12-2018 a las 00:50:33
...
INSERT INTO `album` (`id`, `nombre`, `anio`, `numero_de_canciones`, `activo`, `id_artista`) VALUES
...
INSERT INTO `artista` (`id`, `nombre`, `activo`) VALUES
...
INSERT INTO `cancion` (`id`, `nombre`, `duracion`, `direccion`, `activo`, `id_artista`, `id_album`, `id_genero`) VALUES
...
INSERT INTO `playlist` (`id`, `nombre`, `numero_de_canciones`, `id_usuario`, `activo`) VALUES
(1, 'Favoritas', 2, 4, 1),
...
INSERT INTO `usuario` (`id`, `nombre`, `contrasenia`, `id_tipo_usuario`, `activo`) VALUES
(1, 'Hugo', '123', 1, 1),
(2, 'Hernán', '123', 1, 1),
(3, 'David', '123', 2, 1),
(4, 'Rafael', '123', 2, 1),
...
--
ALTER TABLE `album`
  ADD CONSTRAINT `fk_Album_Artista1` FOREIGN KEY (`id_artista`) REFERENCES `artista` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `artista_genero`
--
ALTER TABLE `artista_genero`
  ADD CONSTRAINT `fk_Artista_has_Genero_Artista1` FOREIGN KEY (`id_artista`) REFERENCES `artista` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Artista_has_Genero_Genero1` FOREIGN KEY (`id_genero`) REFERENCES `genero` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `cancion`
--
ALTER TABLE `cancion`
  ADD CONSTRAINT `fk_Cancion_Album1` FOREIGN KEY (`id_album`) REFERENCES `album` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Cancion_Artista1` FOREIGN KEY (`id_artista`) REFERENCES `artista` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Cancion_Genero1` FOREIGN KEY (`id_genero`) REFERENCES `genero` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `playlist`
--
ALTER TABLE `playlist`
  ADD CONSTRAINT `fk_Playlist_Usuario1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `playlist_con_canciones`
--
ALTER TABLE `playlist_con_canciones`
  ADD CONSTRAINT `fk_Playlist_has_Cancion_Cancion1` FOREIGN KEY (`id_cancion`) REFERENCES `cancion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Playlist_has_Cancion_Playlist1` FOREIGN KEY (`id_playlist`) REFERENCES `playlist` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_Usuario_TipoUsuario` FOREIGN KEY (`id_tipo_usuario`) REFERENCES `tipo_usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
