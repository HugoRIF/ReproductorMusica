...
<nav class="navbar navbar-expand navbar-dark color1 sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            <div class="d-flex flex-row justify-content-center">
                <a href="http://localhost/test/index.php/Musica" class="btn btn-outline-warning">Salir</a>
            </div>
        </div>
</nav>
...
<div class="container-fluid color4">
        <section class="container py-3 mt-2 mb-2">
            ...
            <div class="row mt-2 mb-2 text-center">
                <div class="col">
                    <button class="btn color2 btn-lg border border-dark w-25" href="">Canciones</button>
                </div>
            </div>
            <div class="row mt-2 mb-2 text-center">
                <div class="col">
