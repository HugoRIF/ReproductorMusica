...
<nav class="navbar navbar-expand navbar-dark color1 sticky-top">
        <a class="navbar-brand" href="http://localhost/test/index.php/Musica">
        ...
        <section class="container py-3 mt-2 mb-2">
            ...
            <div class="row ">
                <div class="col-sm-12 col-md-6">
                    ...
                    <img src="http://localhost/test/img/musica/icono2.svg" width="70%" height="70%" class="mx-auto d-block" alt="Musica">
                </div>
                    ...
                    <section class="container">
                            <form action="http://localhost/test/index.php/Musica/login" method="post">
                                <div class="form-group row">
                                    ...
                                    <input type="text" placeholder="Escribe tu usuario:" class="form-control col-8" name="usuario">
